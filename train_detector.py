...
#       pdb.set_trace()
      ...
      rpn_loss1 += rpn_loss_cls.mean().item()
      rpn_loss2 += rpn_loss_box.mean().item()
      RCNN_loss1 += RCNN_loss_cls.mean().item()
      RCNN_loss2 += RCNN_loss_bbox.mean().item()
    ...
    loss1.append(rpn_loss1/step)
    loss2.append(rpn_loss2/step)
    loss3.append(RCNN_loss1/step)
    loss4.append(RCNN_loss2/step)
    loss5.append((rpn_loss1+rpn_loss2+RCNN_loss1+RCNN_loss2)/step)
    plt_loss(epoch, 'output/{}'.format(args.dataset), 'rpn_loss_cls', loss1)
    plt_loss(epoch, 'output/{}'.format(args.dataset), 'rpn_loss_box', loss2)
    plt_loss(epoch, 'output/{}'.format(args.dataset), 'RCNN_loss_cls', loss3)
    plt_loss(epoch, 'output/{}'.format(args.dataset), 'RCNN_loss_bbox', loss4)
    plt_loss(epoch, 'output/{}'.format(args.dataset), 'Total', loss5)
